...
def get_args_parser():
    ...
    parser.add_argument('--food', type=str2bool, default=False,
                        help='Is it the FoodX dataset')
...
def main(args):
    ...
    if args.food:
        ...
        dataset_train = FOODDataset(train_df)
        dataset_val = FOODDataset(val_df)
